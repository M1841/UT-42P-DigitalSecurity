...
<template>
  <div class="gtk-mobile-header">
    ...
    <div class="gtk-mobile-header-center">
      <h1 class="gtk-mobile-header-title">Change your email</h1>
    </div>
  ...
  <div class="gtk-mobile-content">
    <div class="gtk-profile-editor">
      <div class="gtk-container">
        <label class="gtk-label">New email address</label>
        <input
          :value="email"
          type="text"
          class="gtk-input"
        ...
        <p class="gtk-profile-form-hint">
          You will no longer receive security alerts on your previous address.
        </p>
      </div>
      <hr class="gtk-mt-4" />
