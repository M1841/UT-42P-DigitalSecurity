...
<template>
  <div class="gtk-mobile-header">
    ...
    <div class="gtk-mobile-header-center">
      <h1 class="gtk-mobile-header-title">Change your username</h1>
    </div>
  ...
  <div class="gtk-mobile-content">
    <div class="gtk-profile-editor">
      <div class="gtk-container">
        <label class="gtk-label">New username</label>
        <input
          :value="username"
          type="text"
          class="gtk-input"
        ...
        <p class="gtk-profile-form-hint">
          Changing your username might require you to log in again on some
          devices.
        </p>
      </div>
      <hr class="gtk-mt-4" />
